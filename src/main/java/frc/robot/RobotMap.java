...
import frc.robot.commands.ManipulatorSubsystem;
...
public class RobotMap {
  ...
  public static final double DRIVETRAIN_CAMERA_TARGETING_SPEED_MODIFIER = 1.0; //What the value returned by the arduino will be divided by to determine speed
